<x-layouts::app :title="'Expediente de ' . $cliente->nombre">
    ...
    <div class="space-y-6 pb-10 px-4 md:px-0 w-full max-w-full overflow-x-hidden">
        ...
        {{-- 1. CABECERA --}}
        <div class="rounded-xl border border-neutral-200 dark:border-neutral-700 -mx-2 md:mx-0 p-4 md:p-6 bg-white dark:bg-neutral-900 shadow-sm text-left font-bold">
        ...
        <div class="rounded-xl border border-neutral-200 dark:border-neutral-700 -mx-2 md:mx-0 p-4 md:p-6 bg-white dark:bg-neutral-900 shadow-sm text-left">
