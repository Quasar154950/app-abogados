<div class="space-y-6 w-full">
    ...
    <div class="rounded-xl border border-neutral-200 p-4 md:p-6 bg-white shadow-sm dark:bg-neutral-900 dark:border-neutral-700 w-full">
        ...
        <h2 class="text-xl font-bold mb-4 text-left dark:text-white text-neutral-800">
            Agregar Nota
        </h2>
        ...
        <textarea
            ...
            rows="3"
            class="w-full rounded-lg border border-neutral-300 px-3 py-2 dark:bg-neutral-800 dark:border-neutral-700 focus:ring-2 focus:ring-orange-500 outline-none text-sm text-neutral-800 dark:text-neutral-200 font-normal"
            placeholder="Escribe una nota rápida..."
        ></textarea>
        
        @error('contenido')
            <span class="text-xs text-red-500 block mt-1 font-bold italic">
                {{ $message }}
            </span>
        @enderror
        
        <button
            wire:click="agregarNota"
            wire:loading.attr="disabled"
            class="mt-4 inline-flex items-center justify-center gap-2 rounded-xl bg-orange-500 px-10 py-3 text-sm font-bold text-white hover:bg-orange-600 transition w-full md:w-auto cursor-pointer active:scale-95 disabled:opacity-50 shadow-md"
        >

            <span wire:loading.remove wire:target="agregarNota">
                ✔ Guardar nota
            </span>

            <span wire:loading wire:target="agregarNota">
                ⏳ Guardando...
            </span>
    ...
    <div class="rounded-xl border border-neutral-200 p-4 md:p-6 bg-white shadow-sm dark:bg-neutral-900 dark:border-neutral-700 w-full">
        ...
        <h2 class="text-xl font-bold mb-4 text-neutral-400 text-left">
            Historial de Notas
        </h2>
        ...
        <div class="grid grid-cols-1 gap-3 text-left">
            ...
            @empty
                ...
                <p class="col-span-full text-sm text-neutral-400 italic font-normal">
