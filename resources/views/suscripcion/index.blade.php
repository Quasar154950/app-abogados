<x-layouts::app>
    ...
    <div class="max-w-3xl mx-auto p-4 space-y-6">
        ...
        <div class="bg-white dark:bg-neutral-900 rounded-xl shadow p-6 space-y-4">
            ...
            {{-- ESTADO --}}
            <div>
                <p class="text-sm" style="color: #6B7280 !important;">Estado</p>
            ...
            {{-- FECHA --}}
            <div>
                <p class="text-sm" style="color: #6B7280 !important;">Fecha de vencimiento</p>
            ...
            {{-- PLAN --}}
            <div>
                <p class="text-sm" style="color: #6B7280 !important;">Plan</p>
            ...
            {{-- PRECIO --}}
            <div>
                <p class="text-sm" style="color: #6B7280 !important;">Precio mensual</p>
            ...
            {{-- DÍAS RESTANTES --}}
            <div>
                <p class="text-sm" style="color: #6B7280 !important;">Días restantes</p>
                ...
                @if($dias === null)
                    <p class="font-semibold" style="color: #111827 !important;">—</p>

                @elseif($dias < 0)
                    <p class="font-semibold text-red-600">Suscripción vencida</p>

                @elseif($dias <= 5)
                    <p class="font-semibold text-yellow-600">Te quedan {{ $dias }} días</p>

                @else
                    <p class="font-semibold text-green-600">Te quedan {{ $dias }} días</p>
                @endif
            </div>

            {{-- PAGAR SUSCRIPCIÓN --}}
            @if(($user->precio_suscripcion ?? 0) > 0)
